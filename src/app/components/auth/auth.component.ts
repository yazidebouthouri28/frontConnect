...
export class AuthComponent implements OnInit {
  ...
  register(): void {
    ...
    // Split full name into firstName / lastName for Spring Boot
    const nameParts = this.registerForm.name.trim().split(' ');
    ...
    const payload: any = {
      ...
      role:     this.registerForm.role === 'CLIENT' ? 'CUSTOMER' : this.registerForm.role,
